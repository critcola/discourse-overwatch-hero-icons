...
function formatOverwatchHeroNames (text) {
	return text
		...
		.replace(/\b(bash?ti(o|a|e)n)\b/ig, "Bastion<span class=\"ohi-bastion\"></span>")
		.replace(/\b(d.?va)\b/ig, "D.Va<span class=\"ohi-dva\"></span>")
		.replace(/\b(gen(j|g)i)\b/ig, "Genji<span class=\"ohi-genji\"></span>")
		.replace(/\b(h(a|o)nzo)\b/ig, "Hanzo<span class=\"ohi-hanzo\"></span>")
		.replace(/\b(junk ?rat)\b/ig, "Junkrat<span class=\"ohi-junkrat\"></span>")
		.replace(/\b(l(u|ú)(c|s)h?(i|e)o)\b/ig, "Lúcio<span class=\"ohi-lucio\"></span>")
		.replace(/\b(mcc?ree)\b/ig, "McCree<span class=\"ohi-mccree\"></span>")
		.replace(/\b(mei)\b/ig, "Mei<span class=\"ohi-mei\"></span>")
		.replace(/\b(Mer(c|s)e?y)\b/g, "Mercy<span class=\"ohi-mercy\"></span>")
		...
		.replace(/\b(winst(o|i)n)\b/ig, "Winston<span class=\"ohi-winston\"></span>")
